...
dispatch(addUser({uid:uid,email:email,displayName:displayName}));
  ...
  return (
   ...
   <Header/>
    ...
    <img className='h-[700px] md:w-screen' src="https://assets.nflxext.com/ffe/siteui/vlv3/0cf2c109-3af1-4a9d-87d7-aecfac5fe881/web/IN-en-20250217-TRIFECTA-perspective_c3376e06-9aff-4657-aafb-91256a597b7c_large.jpg" alt='logo'/>
